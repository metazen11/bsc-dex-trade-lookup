function checkArbitrage(factory1, router1, router2, fromTokennName, fromTokenAddress, fromTokenDecimals, 
    totokenName, toTokenAddress, toTokenDecimals, BigNumber){
